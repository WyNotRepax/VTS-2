        ...
        do
        {
            ...
            {              
                ...
                if (access(receiverExecFile, X_OK) != -1)
                {
                    ...
                    // TODO: RPC abschicken ...
                    Status status = stub_->subscribe(&clientContext, request, &response);
                     ...
                     (cmd.compare("unsubscribe") == 0))
            {
                ...
                Status status = stub_->unsubscribe(&clientContext, request, &response);
                // TODO: Status / Reply behandeln ...
            ...
            else  /* kein Kommando -> publish() aufrufen */
            {
                ...
                // TODO: RPC abschicken ...
                Status status = stub_->publish(&clientContext, request, &response);
                // TODO: Status / Reply behandeln ...
